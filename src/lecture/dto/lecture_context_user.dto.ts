...
export class CreateLectureContextUserDto {
  @ApiProperty({
...
export class UpdateLectureContextUserDto {
  @ApiProperty({
    description: 'ID của bài giảng',
    example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890',
  })
...
export class GetListLectureContextUserDto extends PaginationRequestDto {
  @ApiProperty({
    description: 'ID của bài giảng',
    example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890',
  })
...
export class BulkCreateLectureContextUserDto {
  @ApiProperty({
